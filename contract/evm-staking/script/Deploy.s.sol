...
contract DeployScript is Script {
    function run() external {
        ...
        // Deploy tokens
        RestrictedStakingToken stakingToken = new RestrictedStakingToken(
            "Restricted Staking Token",
            "RST"
        );
        console.log(
            "RestrictedStakingToken deployed at:",
        ...
        console.log(
            "Enabled safe-exit recipient exemption for staking contract"
        );
        ...
        console.log(
            "Funded",
            rewardSupply / 10 ** 18,
            "reward tokens to staking contract"
        );
